...
namespace WebsiteNoiBoCongTy.Controllers.Admin
{
    public class ManageNotificationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NotificationId,Title,Content,CreateDate,PublishDate,AccountId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NotificationId,Title,Content,CreateDate,PublishDate,AccountId")] Notification notification)
        {
